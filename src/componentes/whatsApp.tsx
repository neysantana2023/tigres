...
export const BtnWhatsApp: React.FC<{}> = () => {
    ...
    return <div className="block-left col-xs-12 col-sm-3 col-md-3 col-lg-3" style={{ "margin": "2" }}>
        <a href="https://api.whatsapp.com/send?phone=5511937773016" aria-label="WhatsWapp"
...
export const WhatsAppFlutuante: React.FC<{}> = () => {
    ...
    return (
        ...
        <a href="https://wa.me/5511937773016" style={{ "position": "fixed", "width": "72px", "height": "71px", "bottom": "30px", "right": "10px", "backgroundColor": "#25d366", "color": "#FFF", "borderRadius": "90px", "textAlign": "center", "fontSize": "40px", "boxShadow": "1px 1px 2px #888", "zIndex": "1000" }} rel="noreferrer" target="_blank">
